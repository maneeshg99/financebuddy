  ...
  return (
    <div className="rounded-md border border-border bg-panel2 p-4">
      <div className="flex items-baseline justify-between">
        ...
        <div className="text-dim text-xs">W={(sub.weight * 100).toFixed(0)}%</div>
      </div>
      <div className={`font-mono text-3xl mt-1 ${scoreClass(s)}`}>
        {s ?? "—"}
        <span className="text-dim text-base">/100</span>
      </div>
